...
class GetAlreadyProcessedApplicationIdTest:
    ...
    def test_already_processed_application_ids_with_fraud_checks(self):
        ...
        application_ids = get_already_processed_applications_ids(123)
        assert 8888 in application_ids
        assert 9999 in application_ids
        assert 1111 not in application_ids
    ...
    def test_already_processed_application_ids_with_all_fraud_checks_status(self):
        ...
        assert 1111 in application_ids
        assert 2222 in application_ids
        assert 3333 not in application_ids
        assert 4444 in application_ids
        assert 5555 not in application_ids
        assert 6666 in application_ids
        assert 7777 in application_ids
