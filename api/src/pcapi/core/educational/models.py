...
class CollectiveOfferTemplateDomain(Model):  # type: ignore [valid-type, misc]
    ...
    collectiveOfferTemplateId = sa.Column(
        sa.BigInteger, sa.ForeignKey("collective_offer_template.id"), index=True, primary_key=True
    )
    ...
    educationalDomainId = sa.Column(sa.BigInteger, sa.ForeignKey("educational_domain.id"), index=True, primary_key=True)
...
class CollectiveOfferDomain(Model):  # type: ignore [valid-type, misc]
    ...
    collectiveOfferId = sa.Column(sa.BigInteger, sa.ForeignKey("collective_offer.id"), index=True, primary_key=True)
    ...
    __table_args__ = (
        sa.UniqueConstraint(
            "collectiveOfferId",
            "educationalDomainId",
            name="unique_collective_offer_domain_association",
        ),
    )
