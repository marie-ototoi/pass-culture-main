...
def get_missing_subscription_steps(
    ...
    if not fraud_api.has_performed_sworn_statement(user):
        missing_steps.append(models.SubscriptionStep.SWORN_STATEMENT)
...
def get_next_subscription_step(user: users_models.User) -> Optional[models.SubscriptionStep]:
    ...
    if needs_to_validate_phone_number(user, user.eligibilityType):
...
def update_user_profile(
    ...
    is_legacy_behaviour: Optional[bool] = False,
) -> None:
