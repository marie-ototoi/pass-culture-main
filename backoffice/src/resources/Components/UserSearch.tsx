...
import {Form, SaveButton, SearchInput, ShowButton, Title, useAuthenticated} from "react-admin";
...
const UserCard = (props: { record: any; }) => {
    ...
    return (
        <Card sx={{minWidth: 275}}>
            ...
            <CardActions>
                <ShowButton/>
                <Button variant={"text"} color={"secondary"}>Consulter ce profil</Button>
            </CardActions>
        </Card>
    )
}
                        ...
                        <Form
                            ...
                            onSubmit={(params) => {
                                ...
                                if (params && params.search) {
                                    setUserData([])
                                    dataProvider.searchList('public_users/search', String(params.search)).then((response: any) => {
